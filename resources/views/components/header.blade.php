...
<body>
    <div  class="webs-menu bg-white">
        <nav class="navbar  px-2 px-lg-5 navbar-expand-lg navbar-light">
            <div class="container-fluid d-flex mx-lg-3 justify-content-between my-0">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('causes')}}">Events</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">Our Causes</a>
                        </li>
                        <li class="nav-item">
